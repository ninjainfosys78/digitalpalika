  ...
  return (
    <>
      ...
      <main className="relative bg-black text-white">
            ...
            <div className="relative mx-auto max-w-[1600px] px-6 lg:px-16">
              ...
              <nav aria-label="Breadcrumb" className="mt-4 text-sm text-white/80">
                <ol className="flex items-center gap-3">
                  <li>
                    <Link href="/" className="font-medium tracking-wide hover:text-white">{content.brand}</Link>
                  </li>
        ...
        {/* WHO WE ARE — dark split section (image left, content right) */}
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  {content.features.map((f) => (
                    <div key={f.title} className="flex items-start gap-3 bg-[#000000] p-4">
                      <span className="inline-flex h-9 w-9 items-center justify-center bg-[#141414] text-[#e3e3e3]">
                        <f.icon size={16} />
                      </span>
                      <div>
   ...
   <div className="mt-8 grid gap-6 md:grid-cols-12">
    ...
    <article key={title} className="md:col-span-4 border bg-[#000000] p-6 shadow-sm rounded-none transition-all hover:-translate-y-0.5 hover:shadow-md">
       <div className="flex items-center gap-3">
         <span className="inline-flex h-10 w-10 items-center justify-center bg-[#141414] text-[#e3e3e3]">
           <Icon size={18} />
         </span>
         <h3 className="text-lg font-heading font-semibold text-white text-left">{title}</h3>
       </div>
         ...
         <section id="our-story" className="relative z-10 scroll-mt-28">
          <div className="mx-auto max-w-[1600px] px-6 sm:px-8 lg:px-12 py-12 lg:py-16">
            ...
            <div className="relative mt-10">
              {/* Center line (white) */}
              <span className="pointer-events-none absolute left-1/2 top-0 h-full w-px -translate-x-1/2 bg-white/50" />
              ...
              <ol className="space-y-12">
                {content.timeline.map((t, i) => (
                  ...
                  >
                    ...
                    <span className="absolute left-1/2 top-6 z-10 -translate-x-1/2 flex h-4 w-4 items-center justify-center rounded-full bg-[#d52020] ring-2 ring-white" />

                    {/* Card - alternates sides on md+; use flex to align card near center */}
                    <div
                      className={
                        i % 2 === 0
                    ...
                    >
                      <div className="max-w-[420px] w-full border border-white/20 bg-[#050505] p-6 rounded-none text-slate-200">
                        <div className="text-xs font-semibold tracking-wide text-slate-400">
                          {t.year}
                        </div>
                        <h3 className="mt-2 text-lg font-heading font-semibold text-white text-left">{t.title}</h3>
