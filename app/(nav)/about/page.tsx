            ...
            <div className="relative mx-auto max-w-[1600px] px-6 lg:px-16">
              <div className="max-w-[1600px] text-left">
                <nav
                  ...
                  className="mt-0 text-sm text-[#f3f3f3e6]"
                >
                  <ol className="flex items-center gap-3">
                    <li>
                      <Link
                        href="/"
                        className="font-medium tracking-wide hover:text-[#f3f3f3e6]"
                      >
                        {content.brand}
                      </Link>
                    </li>
                    <li aria-hidden className="inline-flex items-center">
                      <svg
                        viewBox="0 0 24 24"
                        className="h-5 w-5 text-[#f3f3f3e6]"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="2"
                      >
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  {content.features.map((f) => {
                    ...
                    return (
                      <div
                        key={f.title}
                        className="flex items-start gap-3 bg-[#000000] p-4"
                      >
                        <span className="inline-flex h-9 w-9 items-center justify-center bg-[#141414] text-[#f3f3f3e6]">
                          <Icon size={16} />
                        </span>
                        <div>
                          <div className="text-sm font-semibold text-[#f3f3f3e6]">
                            {f.title}
                          </div>
                          <div className="text-xs text-[#f3f3f3e6]">
                            {f.desc}
                          </div>
                        </div>
                      </div>
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-12">
              {content.core.map(({ icon: Icon, title, body }) => (
                ...
                >
                  ...
                  <p className="mt-3 text-sm leading-6 text-[#f3f3f3e6]">
                    {body}
                  </p>
                </article>
              ))}
                  ...
                  >
                    ...
                    >
                      <div className="max-w-[420px] w-full border border-[#f3f3f3e6]/20 bg-[#050505] p-6 rounded-none text-[#f3f3f3e6]">
                        ...
                        <p className="mt-3 text-sm text-[#f3f3f3e6]">
                          {t.text}
                        </p>
                      </div>
                    </div>
