...
export const siteData: FullSiteContent = {
    header: {
        navItems: [
            ...
            { label: { en: 'Our Clients', ne: 'हाम्रा ग्राहक' }, href: '/clients' },
    ...
    statistics: [
        ...
        { id: 2, value: { en: '8,00,000 +', ne: '८,००,००० +' }, label: { en: 'लाभान्वित नागरिक', ne: '' } },
    ...
    demoCta: {
        title: { en: 'Ready to see a demo?', ne: 'डेमो हेर्न चाहनुहुन्छ?' },
        description: { 
        ...
        sections: [
            ...
            },
            {
                ...
                content: {
                    type: 'list',
                    items: [
                        { en: "Make local bodies technology-friendly.", ne: 'डिजिटल प्रविधिमैत्री देवी बनाउनु।' },
                        { en: "Support municipalities in daily operations as digital municipalities.", ne: 'पालिकालाई डिजिटल पालिकामै दैनिक कार्यसम्पादन गर्न सहयोग पुग्नु।' },
                        { en: "Provide information to everyone through mobile apps and other visual media.", ne: 'मोबाइल एप मार्फत सबैजना जानकारीलाई साथै अन्य दृश्य माध्यमले जानकारी गराउनु।' },
                        { en: "Enable most services provided by municipalities to accept applications, process, and deliver services online.", ne: 'पालिकाले प्रवाह गर्ने सेवाहरू मध्ये धेरै जसो सेवालाई अनलाइन मार्फत आवेदन लिने, कार्य सम्पादन गर्ने र सेवा प्रदान गर्ने।' },
                        { en: "Save time for representatives, employees, and service recipients of municipalities.", ne: 'पालिकाको जनप्रतिनिधि, कर्मचारी र सेवाग्राहीको समय बचत गर्नु।' },
                        { en: "Prepare an integrated system for revenue collection, information, statistics, service delivery, and reporting.", ne: 'पालिकालाई एकीकृत राजस्व संकलन, सूचना, तथ्यांक, सेवाप्रवाह र सोको रिपोर्टसहित निकाल्न मिल्ने गरि तयार हुनु।' },
                        { en: "Help local bodies manage issues like misuse of translation, actual details, and statistics when connecting with technology.", ne: 'स्थानीय तहलाई प्रविधि सँग जोड्दा अनुवाद दुरुपयोग, वास्तविक विवरण, तथ्यांक लगायत देखिने त्रुटि पालिकाहरूलाई स्थानीय तहमा हुने प्रकारको समस्यालाई बेअसर व्यवस्थापनमा सहयोग पुग्नु।' },
                        { en: "Ensure that the concept of complete digital e-municipality allows all work processes, services, and citizen experiences to be performed and felt through technology.", ne: 'सम्पूर्ण डिजिटल ई-पालिकाको अवधारणाले पालिकाहरूको सम्पूर्ण कार्य प्रणाली, सेवा जोड्दा, प्रविधि मार्फत नै सबैको कार्यसम्पादन गर्दा र स्थानीयवासीले यसै पालिकामै पुगेको अनुभूति प्राप्त गर्ने।' },
                        { en: "Integrate all municipal services online.", ne: 'पालिकाको सम्पूर्ण सेवाहरूलाई अनलाइन बनाउन यो विवरण वस्तुस्थितिमा एकीकृत हुनु।' },
                        { en: "Provide an integrated mobile and web-based system.", ne: 'एकीकृत मोबाइल र वेबमा आधारित प्रणाली प्रदान गर्नु।' },
                        { en: "Increase active participation of citizens in daily municipal activities.", ne: 'पालिकाको दैनिक गतिविधिहरूमा नागरिकको सक्रिय संलग्नता बढाउनु।' }
                    ]
                },
    ...
    featuresPage: {
        ...
        items: [
            { id: 1, icon: 'monitor', title: { en: 'Mobile & Web System', ne: 'मोबाइल र वेबमा' }, description: { en: 'Integrated mobile and web-based system.', ne: 'एकीकृत मोबाइल र वेबमा आधारित प्रणाली' } },
            { id: 2, icon: 'building', title: { en: 'Information Hub', ne: 'जानकारी' }, description: { en: 'Individual, business, and institutional data.', ne: 'व्यक्तिगत, व्यवसाय र संस्थागत जानकारी' } },
            { id: 3, icon: 'list-check', title: { en: 'Daily Activities', ne: 'दैनिक गतिविधिहरू' }, description: { en: 'Enhancing citizen participation in daily municipal activities.', ne: 'पालिकाको दैनिक गतिविधिहरूमा नागरिकको सक्रिय संलग्नता' } },
            { id: 4, icon: 'calculator', title: { en: 'Online Access', ne: 'अनलाइनमा पहुँच' }, description: { en: 'Access to citizen services and information online.', ne: 'नागरिकका सेवा र जानकारीको अनलाइनमा पहुँच' } },
            { id: 5, icon: 'info-circle', title: { en: 'Workflow Support', ne: 'कार्यसम्पादन गर्न सहयोग' }, description: { en: 'Support for daily work execution in the municipality.', ne: 'पालिकाको दैनिक कार्यसम्पादन गर्न सहयोग' } },
            { id: 6, icon: 'video', title: { en: 'Client Information', ne: 'सेवाग्राहीलाई जानकारी' }, description: { en: 'Providing information to clients via audio and video.', ne: 'सेवाग्राहीलाई अडियो, भिडियो मार्फत जानकारी' } },
            { id: 7, icon: 'smartphone', title: { en: 'Online Services', ne: 'अनलाइन सेवाहरु' }, description: { en: 'Simplifying access to municipal services online.', ne: 'पालिकाले प्रवाह गर्ने सेवाहरुलाई अनलाइन मार्फत आवेदन लिने, दर्ता गर्ने र प्रमाणपत्र प्रदान' } },
            { id: 8, icon: 'zap', title: { en: 'Time Saving', ne: 'समय बचत' }, description: { en: 'Saving time for representatives, employees, and clients.', ne: 'पालिकाको जनप्रतिनिधि, कर्मचारी र सेवाग्राहीको समयको बचत' } },
            { id: 9, icon: 'box', title: { en: 'Unified Software', ne: 'एकीकृत सफ्टवेयर' }, description: { en: 'Integrating various municipal functions into a unified software platform.', ne: 'पालिकालाई एकीकृत सफ्टवेयरमा आवद्ध गरि सुचना, तथ्यांक, सेवाप्रवाहमा सहज' } },
            { id: 10, icon: 'list-check', title: { en: 'Workflow Automation', ne: 'कार्यप्रवाह स्वचालन' }, description: { en: 'Automating workflows for efficiency.', ne: 'सेसमग्र पालिकाको कामलाई प्रबिधि मार्फत नै गर्ने' } },
            { id: 11, icon: 'users', title: { en: 'Client Experience', ne: 'पालिकाबासीको अनुभुती' }, description: { en: 'Providing a seamless experience for citizens interacting with the municipality sitting from home.', ne: 'पालिकाबासीले घरमै बसेर पालिका पुगेको अनुभुती' } }
        ],
    },
    ...
    footer: {
        ...
        contactInfo: {
            ...
            details: [
                { label: { en: 'Address', ne: 'ठेगाना' }, value: { en: 'Kathmandu, Nepal', ne: 'काठमाडौं, नेपाल' } },
                { label: { en: 'Email', ne: 'इमेल' }, value: { en: 'info@ninjainfosys.com', ne: 'info@ninjainfosys.com' } },
                { label: { en: 'Mobile', ne: 'मोबाइल' }, value: { en: '+977-9858042433', ne: '+977-9858042433, +977-9858042647' } },
                { label: { en: 'Phone', ne: 'फोन' }, value: { en: '01-5922361', ne: '01-5922361' } },
            ],
            note: { en: '', ne: '' }
        },
